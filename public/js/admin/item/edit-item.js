$(document).ready(function(){
    ...
    $("#submit").click(function(){
        ...
        showAlert("Đang chỉnh sửa item...", 3);
        $.ajax({
            method: "PUT",
            url: '/admin/item/edit-item',
            data: {name: nameItem, slug: slug, itemId: $('#itemId').val() ,_csrf: $('#_csrf').val()},
            success: res => {
                showAlert("Chỉnh sửa item '" + nameItem + "' thành công!", 1);
